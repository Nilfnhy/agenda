...
from .views import AgendamentosView, AgendamentoAddView, AgendamentoUpdateView, AgendamentoDeleteView, AgendamentoInLineEditView, AgendamentoExibirView
...
urlpatterns = [
    ...
    path('<int:pk>/agendamento/exibir', AgendamentoExibirView.as_view(), name='agendamento_exibir'),
]
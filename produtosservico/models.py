...
class ProdutosServico(models.Model):
    ...
    quantidade = models.DecimalField( 'Quantidade', max_digits=5, decimal_places=2, help_text='Quantidade de produto utilizada')

    class Meta:
        verbose_name = 'Produto utilizado'
        verbose_name_plural = 'Produto utilizados'
